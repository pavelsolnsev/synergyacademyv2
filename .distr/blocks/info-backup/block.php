        ...
        <div class="program__block">
            <div class="program__block-wrapper">
                ...
                <div class="program__block-select">
                    ...
                    <div class="program__block-sub">
                        {% for item in items %}
                            <div class="program__block-sub-link {{ item.class | safe }} active {{ item.courseActive | safe }}" data-course="{{ item.link | safe }}"  data-identification="{{ item.identification | safe }}">{{ item.direction | safe }}</div>
                        {% endfor %}
                    </div>
            ...
            <div class="program__block-content">
                {% for item in items %}
                        ...
                        <div class="program__item {{ item.courseActive_main | safe }}" data-target="{{ item.identification | safe }}">
